...
public class ResetPassword extends AppCompatActivity  {
    ...
    private static final String IS_CHANGE_PASSWORD ="com.example.homeactivity.auth.isChangepassword" ;
...
//                    Intent intent = new Intent(ResetPassword.this, SettingsActivity.class);
...
//                    finish();
        ...
        else
        {
            ...
            buttonResetPassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(ResetPassword.this,"Password Reset, Check Your Email",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ResetPassword.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
        ...
        call.enqueue(new Callback<UsersModel>() {
            ...
            public void onResponse(Call<UsersModel> call, Response<UsersModel> response) {
                if (response.code() == 200){
                    Intent intent = new Intent(ResetPassword.this, LoginActivity.class);
                    startActivity(intent);
                    Toast.makeText(ResetPassword.this,"Password Changed, Confirm Login",Toast.LENGTH_SHORT).show();
                    finish();
                }
                else{
                    Toast.makeText(ResetPassword.this,"Login not correct", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<UsersModel> call, Throwable t) {
                Toast.makeText(ResetPassword.this,"Network Failure, Please Try Again", Toast.LENGTH_SHORT).show();
