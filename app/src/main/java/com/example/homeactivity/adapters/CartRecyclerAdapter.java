...
public class CartRecyclerAdapter extends RecyclerView.Adapter<CartRecyclerAdapter.ViewHolder> {
    ...
    CartManager cartManager;    public CartRecyclerAdapter(Context context, List<CartResponse> list) {
        mContext = context;
        cartManager = new CartManager(context);        mCartArrayList = list;
    }    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ).placeholder(R.drawable.ic_cart).into(holder.cart_image);    }    @Override
    public int getItemCount() {
        return mCartArrayList.size();
    }    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ImageView cart_image;
        TextView product_name, product_price;
        Button btn_remove, btn_edit;        public ViewHolder(@NonNull View itemView) {
            super(itemView);
